 ...
 */
final class Version20200706232947 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        // $this->addSql('CREATE TABLE recipes_images (recipes_id INT NOT NULL, images_id INT NOT NULL, INDEX IDX_FB1120B0FDF2B1FA (recipes_id), INDEX IDX_FB1120B0D44F05E5 (images_id), PRIMARY KEY(recipes_id, images_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
